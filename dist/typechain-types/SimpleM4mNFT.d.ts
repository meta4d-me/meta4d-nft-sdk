...
export interface SimpleM4mNFTInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "minter", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "tokenIndex", values?: undefined): string;
...
export interface SimpleM4mNFT extends BaseContract {
    ...
    functions: {
        ...
        mint(to: string, ipfsHash: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        safeMint(to: string, ipfsHash: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getApproved(tokenId: BigNumberish, overrides?: CallOverrides): Promise<string>;
        isApprovedForAll(owner: string, operator: string, overrides?: CallOverrides): Promise<boolean>;
        mint(to: string, ipfsHash: string, overrides?: CallOverrides): Promise<void>;
        mintPaused(overrides?: CallOverrides): Promise<boolean>;
        minter(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
        name(overrides?: CallOverrides): Promise<string>;
        ownerOf(tokenId: BigNumberish, overrides?: CallOverrides): Promise<string>;
        safeMint(to: string, ipfsHash: string, overrides?: CallOverrides): Promise<void>;
    ...
    populateTransaction: {
        ...
        minter(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;

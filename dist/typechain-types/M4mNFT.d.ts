...
export interface M4mNFTInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "updateBaseURI", values: [string]): string;
...
export interface M4mNFT extends BaseContract {
    ...
    functions: {
        ...
        initialize(__baseURI: string, _registry: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        updateBaseURI(uri: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    approve(to: string, tokenId: BigNumberish, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        getApproved(tokenId: BigNumberish, overrides?: CallOverrides): Promise<string>;
        initialize(__baseURI: string, _registry: string, overrides?: CallOverrides): Promise<void>;
        isApprovedForAll(owner: string, operator: string, overrides?: CallOverrides): Promise<boolean>;

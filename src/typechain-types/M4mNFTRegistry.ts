...
export type AssembleEvent = TypedEvent<[BigNumber, BigNumber[], BigNumber[]],
...
export type ClaimedLootEvent = TypedEvent<[string, BigNumber[], BigNumber[]],
    { owner: string; componentIds: BigNumber[]; amount: BigNumber[] }>;

export type ClaimedLootEventFilter = TypedEventFilter<ClaimedLootEvent>;

export type ConvertToM4mNFTEvent = TypedEvent<[string, string, BigNumber, BigNumber],
    {
        owner: string;
        original: string;
...
export type InitializeEvent = TypedEvent<[BigNumber, BigNumber[], BigNumber[]],
    { m4mTokenId: BigNumber; componentIds: BigNumber[]; amount: BigNumber[] }>;
...
export type RedeemEvent = TypedEvent<[string, string, BigNumber, BigNumber],
    {
        owner: string;
        original: string;
        originalTokenId: BigNumber;
...
export type SplitEvent = TypedEvent<[BigNumber, BigNumber[], BigNumber[]],
    { m4mTokenId: BigNumber; componentIds: BigNumber[]; amount: BigNumber[] }>;
